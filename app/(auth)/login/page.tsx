    ...
    <div className="min-h-[calc(100vh-10rem)] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-[400px]">
        ...
        <p className="text-center text-[14px] text-[#6a6f73] mb-8">
          アカウントをお持ちでない方は{" "}
          <Link href="/register" className="text-[#a435f0] hover:text-[#8710d8] font-bold underline">
            新規登録
          </Link>
        </p>
        ...
        <div className="border border-[#d1d7dc] bg-white p-6">
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#d1d7dc]" />
            </div>
            <div className="relative flex justify-center text-[12px]">
              <span className="px-3 bg-white text-[#6a6f73] uppercase font-bold tracking-wider">または</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-[#1c1d1f] text-[15px] font-bold text-[#1c1d1f] bg-white hover:bg-[#f7f9fa] transition-colors disabled:opacity-50"
          >
